# from https://medium.com/@ryujimorita.1009/how-i-built-a-booking-automation-bot-to-get-a-popular-cafe-admission-ticket-851bb2f9eac0
...
def make_a_reservation(reservation_time:int, reservation_name:str) -> bool:
	...
	# press book button
        ...
        for idx, info in enumerate(fill_info):
            driver.find_element_by_xpath(f'//*[@id="frontLessonBookingEditForm"]/section[2]/table/tbody/tr[{idx+1}]/td/div/input')\
		  .send_keys(info)
